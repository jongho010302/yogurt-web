    ...
    <div class="col-8">
      ...
      <q-stepper v-model="step" ref="stepper" :active-color="primaryColor" :done-color="primaryColor" class="no-shadow" animated>
        <q-step :name="1" title="Enter basic information" icon="assignment" :done="step > 1">
          ...
          <q-input v-model="name" dense placeholder="Please enter your name" :color="primaryColor" style="width: 300px" class="q-mb-xl" @input="handleNameChange">
            <template v-slot:append>
              <q-icon v-if="!nameVerified" name="warning">
                <q-tooltip>
                  Please format your name.
                </q-tooltip>
              </q-icon>
            </template>
          </q-input>
          ...
          <div class="q-mb-xl row">
            <q-input v-model="username" dense placeholder="Please enter your username" :color="primaryColor" style="width: 300px" class="q-mr-sm" @input="handleUsernameChange">
              <template v-slot:append>
                <q-icon v-if="!usernameVerifyVisible" name="warning">
                  <q-tooltip>
                    Username must be 8 to 20 length.
                  </q-tooltip>
                </q-icon>
              </template>
            </q-input>
            <q-btn v-if="usernameVerifyVisible" color="black" rounded @click="handleUsernameVerifyClick">Verify</q-btn>
          </div>

          <!-- Email -->
          <div class="text-weight-bold">Email</div>
          <div class="q-mb-xl row">
            <q-input v-model="email" type="email" dense placeholder="Please enter your email" :color="primaryColor" style="width: 300px" class="q-mr-sm" @input="handleEmailChange">
              <template v-slot:append>
                <q-icon v-if="!emailDuppVerificationVisible" name="warning">
                  <q-tooltip>
                    Please format your email.
                  </q-tooltip>
                </q-icon>
              </template>
            </q-input>
            <q-btn v-if="emailDuppVerificationVisible" class="q-mr-sm" color="black" rounded @click="handleEmailDuppVerifyClick">Verify</q-btn>
          </div>

          <!-- Email Verification Code -->
          <div class="text-weight-bold">Email Verification Code</div>
          <div class="q-mb-xl row">
            <q-input v-model="emailVerificationCode" type="email" :disable="!emailDuppVerified" dense placeholder="Please enter your verification code" :color="primaryColor" style="width: 300px" class="q-mr-sm" />
            <q-btn v-if="emailDuppVerified" class="q-mr-sm" color="black" rounded @click="handleEmailSendCodeClick">Send Code</q-btn>
            <q-btn v-if="emailDuppVerified" color="black" rounded @click="handleEmailVerificationCodeClick">Verify</q-btn>
          </div>

          <!-- Phone number -->
          <div class="text-weight-bold">Phone number</div>
          <q-input v-model="phoneNumber" dense placeholder="Please enter your phone number" :color="primaryColor" mask="###-####-####" style="width: 300px" class="q-mb-xl" @input="handlePhoneNumberChange">
            <template v-slot:append>
              <q-icon v-if="!phoneNumberVerified" name="warning">
                <q-tooltip>
                  Please format your phone number.
                </q-tooltip>
              </q-icon>
            </template>
          </q-input>
          ...
          <q-option-group v-model="gender" :options="genderOptions" :color="primaryColor" inline class="q-mb-xl" />

          <!-- role -->
          <div class="text-weight-bold">Role</div>
          <q-option-group v-model="role" :options="roleOptions" :color="primaryColor" inline class="q-mb-xl" />

          <!-- Birth -->
          <div class="text-weight-bold">Birth</div>
          <q-input v-model="birth" :color="primaryColor" mask="####-##-##" dense class="q-mb-xl" style="width: 120px; height: 50px">
        ...
        <q-step :name="2" title="Enter Working time" icon="assignment" :done="step > 2">
          <div class="text-h5 text-weight-bold q-mb-lg">working time</div>

          <div class="text-weight-bold q-mb-md q-mt-md">monday</div>
          <div class="row items-center">
            <q-input v-model="monWorkingStartTime" dense :disable="isMonDayOff" class="q-mr-md" style="width: 100px" /> ~
            <q-input v-model="monWorkingEndTime" dense :disable="isMonDayOff" class="q-ml-md" style="width: 100px" />
          ...
          <div class="row items-center">
            <q-input v-model="tueWorkingStartTime" dense :disable="isTueDayOff" class="q-mr-md" style="width: 100px" /> ~
            <q-input v-model="tueWorkingEndTime" dense :disable="isTueDayOff" class="q-ml-md" style="width: 100px" />
          ...
          <div class="row items-center">
            <q-input v-model="wedWorkingStartTime" dense :disable="isWedDayOff" class="q-mr-md" style="width: 100px" /> ~
            <q-input v-model="wedWorkingEndTime" dense :disable="isWedDayOff" class="q-ml-md" style="width: 100px" />
          ...
          <div class="row items-center">
            <q-input v-model="thuWorkingStartTime" dense :disable="isThuDayOff" class="q-mr-md" style="width: 100px" /> ~
            <q-input v-model="thuWorkingEndTime" dense :disable="isThuDayOff" class="q-ml-md" style="width: 100px" />
          ...
          <div class="row items-center">
            <q-input v-model="friWorkingStartTime" dense :disable="isFriDayOff" class="q-mr-md" style="width: 100px" /> ~
            <q-input v-model="friWorkingEndTime" dense :disable="isFriDayOff" class="q-ml-md" style="width: 100px" />
          ...
          <div class="row items-center">
            <q-input v-model="satWorkingStartTime" dense :disable="isSatDayOff" class="q-mr-md" style="width: 100px" /> ~
            <q-input v-model="satWorkingEndTime" dense :disable="isSatDayOff" class="q-ml-md" style="width: 100px" />
          ...
          <div class="row items-center">
            <q-input v-model="sunWorkingStartTime" dense :disable="isSunDayOff" class="q-mr-md" style="width: 100px" /> ~
            <q-input v-model="sunWorkingEndTime" dense :disable="isSunDayOff" class="q-ml-md" style="width: 100px" />
        ...
        <template v-slot:navigation>
          <q-stepper-navigation>
            <q-btn @click="handleSubmit($refs.stepper);" :color="primaryColor" :label="step === 3 ? 'Finish' : 'Continue'" />
...
import { usernameRegex, nameRegex, emailRegex, phoneNumberRegex } from '@/util/regex';
...
export default class StaffCreate extends Vue {
  ...
  async handleEmailDuppVerifyClick() {
    const res: ApiResponse = await this.$store.dispatch(`${authNamespace}/handleEmailDuppVerify`, { email: this.$data.email });
  ...
  async handleEmailSendCodeClick() {
    const res: ApiResponse = await this.$store.dispatch(`${authNamespace}/handleEmailVerficiationCodeSend`, { email: this.$data.email });
  ...
  async handleEmailVerificationCodeClick() {
    const res: ApiResponse = await this.$store.dispatch(`${authNamespace}/handleEmailVerificationCodeCheck`, {
  ...
  hadleWorkingTimeValidation(): boolean {
    if (!this.$data.isMonDayOff && !(this.$data.monWorkingStartTime && this.$data.monWorkingEndTime)) {
      yogurtAlert('Please enter your monday.');
      return false;
    }
    if (!this.$data.isTueDayOff && !(this.$data.tueWorkingStartTime && this.$data.tueWorkingEndTime)) {
      yogurtAlert('Please enter your tuesday.');
      return false;
    }
    if (!this.$data.isWedDayOff && !(this.$data.wedWorkingStartTime && this.$data.wedWorkingEndTime)) {
      yogurtAlert('Please enter your wednesday.');
      return false;
    }
    if (!this.$data.isThuDayOff && !(this.$data.thuWorkingStartTime && this.$data.thuWorkingEndTime)) {
      yogurtAlert('Please enter your thursday.');
      return false;
    }
    if (!this.$data.isFriDayOff && !(this.$data.friWorkingStartTime && this.$data.friWorkingEndTime)) {
      yogurtAlert('Please enter your friday.');
      return false;
    }
    if (!this.$data.isSatDayOff && !(this.$data.satWorkingStartTime && this.$data.satWorkingEndTime)) {
      yogurtAlert('Please enter your saturday.');
      return false;
    }
    if (!this.$data.isSunDayOff && !(this.$data.sunWorkingStartTime && this.$data.sunWorkingEndTime)) {
